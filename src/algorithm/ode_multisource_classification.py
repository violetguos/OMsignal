...
from algorithm.torchdiffeq import odeint_adjoint as odeint
...
class DownSampleFFT_sub(nn.Module):
    ...
    def __init__(
        ...
        self.conv1_num_filters, self.conv2_num_filters = (
            conv1_num_filters,
            conv2_num_filters,
        )
        ...
        self.pool1 = nn.MaxPool1d(
            kernel_size=pool_ksize * 2, stride=pool_stride + 1, padding=pool_padding
        )

        #   Conv2
        self.conv2 = nn.Conv1d(
            self.conv1_num_filters,
            self.conv2_num_filters,
...
class DownSampleSig_full(nn.Module):
    ...
    def __init__(
        ...
        # Set hyperparameters needed in forward
        self.conv1_num_filters, self.conv2_num_filters, self.conv3_num_filters = (
            conv1_num_filters,
            conv2_num_filters,
            conv3_num_filters,
        )
...
class DownSampleFFT_full(nn.Module):
    ...
    def __init__(
        ...
        self.pool2 = nn.MaxPool1d(
            kernel_size=pool_ksize, stride=pool_stride + 1, padding=pool_padding
        )
